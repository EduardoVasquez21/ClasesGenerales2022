...
INSERT INTO `estudiante` VALUES (10,'Ed','Vasquez'),(11,'Edy','Lopez'),(12,'Eduar','Vasquez');
...
INSERT INTO `materia` VALUES (1,'Progra3');
...
--
/*!50003 DROP PROCEDURE IF EXISTS `SPS_LOG` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SPS_LOG`(PPUSUARIO varchar(45), PPPASS varchar(45))
BEGIN
 select * from usuario u where u.user= PPUSUARIO and u.password = md5(PPPASS);
END ;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `SP_I_USER` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_I_USER`(PrUser varchar(45), PPASSWORD varchar(45))
BEGIN
INSERT INTO `clase`.`usuario` (`user`, `password`) VALUES (PrUser, md5(PPASSWORD));
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_S_LOGEO`(PPUSUARIO varchar(45), PPPASS varchar(45))
BEGIN
select * from usuario;
END ;;
DELIMITER ;
...
-- Dump completed on 2022-03-22 18:25:39
